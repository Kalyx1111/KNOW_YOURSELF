...
/* ---------------------------------------------------------------------
   SECURITY: escape any untrusted string before it is ever inserted into
   innerHTML. Defense-in-depth — this build currently has no free-text
   input fields (all answers are button/select driven), so there is no
   live injection point today, but this guarantees any future free-text
   field (e.g. a personal note on a result) is safe by default rather
   than by omission. Matches the security bar of the rest of the Aryan
   suite (AI Interview Master, Crypto Master, Ethical Hacking Master).
   --------------------------------------------------------------------- */
